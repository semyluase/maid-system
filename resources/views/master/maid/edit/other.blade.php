                    ...
                    <div class="card">
                        <form action="#" method="post" id="form-data-edit" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                @include('master.maid.edit.partials.other.data')
                                <div class="divider-left divider">
                                    <div class="divider-text">Work Experience</div>
                                </div>
                                @include('master.maid.edit.partials.other.workExperience')
                                <div class="divider-left divider">
                                    <div class="divider-text">Language</div>
                                </div>
                                @include('master.maid.edit.partials.other.language')
                                <div class="divider-left divider">
                                    <div class="divider-text">Speciality</div>
                                </div>
                                @include('master.maid.edit.partials.other.skill')
                                <div class="divider-left divider">
                                    <div class="divider-text">Willingness</div>
                                </div>
                                @include('master.maid.edit.partials.other.willingness')
                                <div class="divider-left divider">
                                    <div class="divider-text">Other</div>
                                </div>
                                @include('master.maid.edit.partials.other.other')
                                <div class="divider-left divider">
                                    <div class="divider-text">Remarks</div>
                                </div>
                                @include('master.maid.edit.partials.other.remark')
                            </div>
