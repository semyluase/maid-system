...
const doiPasporMaidInput = document.querySelector("#doiPasporMaid");
const doePasporMaidInput = document.querySelector("#doePasporMaid");
...
const fnFormMaid = {
    init: {
        buttons: {
            ...
            btnCalendarDoi: document.querySelector("#btn-calendar-doi"),
            btnCalendarDoe: document.querySelector("#btn-calendar-doe"),
        },
        datePicker: {
            ...
            doi: new Datepicker(doiPasporMaidInput, {
                format: "dd-mm-yyyy",
                buttonClass: "btn",
                todayBtn: true,
                autohide: true,
            ...
            doe: new Datepicker(doePasporMaidInput, {
                format: "dd-mm-yyyy",
                buttonClass: "btn",
                todayBtn: true,
                autohide: true,
...
fnFormMaid.init.buttons.btnCalendarDoi.addEventListener("click", () => {
    fnFormMaid.init.datePicker.doi.show();
});

fnFormMaid.init.buttons.btnCalendarDoe.addEventListener("click", () => {
    fnFormMaid.init.datePicker.doe.show();
});
