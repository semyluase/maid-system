...
const employerWorkInput = document.querySelector("#employerWork");
const descriptionWorkInput = document.querySelector("#descriptionWork");
const workSingaporeCheck = document.querySelector("#workSingapore");
const employerFeedbackWorkInput = document.querySelector(
    "#employerFeedbackWork"
);
const remarksWorkInput = document.querySelector("#remarksWork");
...
const fnFormMaid = {
    init: {
        ...
        tables: {
            ...
            tbWorkFeedback: $("#tb-work-experience-feedback").DataTable({
                ajax: `${baseUrl}/master/maids/get-work-feedback?country=${countryRequestInput.value}&maid=${codeMaidInput.value}`,
            }),
        },
    },
        ...
        await fetch(`${baseUrl}/master/maids/get-work-experience/${id}/edit`)
            ...
            .then((response) => {
                ...
                employerFeedbackWorkInput.value =
                    response.employeer_singapore_feedback;
    ...
    switch (fnFormMaid.init.buttons.btnSaveWork.dataset.type) {
        case "add-data":
            ...
            data = JSON.stringify({
                ...
                remarks: remarksWorkInput.value,
                workSingapore: workSingaporeCheck.checked,
